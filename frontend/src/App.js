  ...
  return (
    <section className="relative" data-testid="sleep-section">
      <div className="relative w-full overflow-visible">
        <img
          src="https://customer-assets.emergentagent.com/job_afa1f63c-426b-4bce-8438-0d015601c035/artifacts/5nbjbqzc_A%2B%20Basic%20Content%20%28A4%20%28Landscape%29%29%20%285%29.png"
...
const Reviews = () => {
  ...
  const reviews = [
    { name: "Sarah M.", location: "Sydney, AU", stars: 5, category: "Sleep", text: "I couldn't believe how much better I slept the very first night. Less tossing and turning, more restful sleep, and I finally wake up feeling energized instead of groggy." },
    { name: "James T.", location: "Melbourne, AU", stars: 5, category: "Sport", text: "I used these for a 15-mile run and my average pace was significantly faster while my heart rate stayed lower than usual. Being able to maintain nasal breathing during cardio is a total game-changer." },
    { name: "Emma L.", location: "Brisbane, AU", stars: 5, category: "Sleep", text: "My partner says I snore way less now, and I wake up feeling completely refreshed. It's the first time in years I've slept through the entire night breathing only through my nose." },
    { name: "Daniel K.", location: "Perth, AU", stars: 5, category: "Sport", text: "The adhesive is incredible. I can go for a morning run, sweat through a workout, and the strip doesn't budge. It feels like my airways are 35% wider." },
    ...
    { name: "Chris W.", location: "Gold Coast, AU", stars: 5, category: "Sleep", text: "I wear a fitness tracker and my recovery scores have improved by 5% over the last three months of using these. No more dry mouth or bad breath in the morning either." },
    { name: "Mia H.", location: "Bondi, AU", stars: 5, category: "Sport", text: "I wore one during a marathon and was able to nose-breathe the entire race. It stops my nose from 'collapsing' when I take deep breaths during heavy efforts." },
    { name: "Liam P.", location: "Coogee, AU", stars: 4, category: "Congestion", text: "Perfect for when you have a cold or sinus infection. It's a drug-free way to actually get some sleep when you're congested." },
    ...
    { name: "Tom A.", location: "Wollongong, AU", stars: 4, category: "Sleep", text: "Simple to use and effective. If you feel like you aren't getting enough air, especially at night, this is the most immediate solution I've found." },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <motion.div {...fadeUp} className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {visibleReviews.map((review, i) => (
            <div
              key={`${activeIndex}-${i}`}
              className="bg-[#050505] border border-white/5 p-6 md:p-8 flex flex-col justify-between"
              itemScope
              itemProp="review"

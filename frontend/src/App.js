...
const Reviews = () => {
  ...
  const reviews = [
    ...
    { name: "Daniel K.", location: "Perth, AU", stars: 5, category: "Sport", text: "The adhesive is unreal. I can smash out a morning run, sweat through a full session, and the strip doesn't budge. It feels like my airways are 35% wider." },

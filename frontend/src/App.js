...
const ASSETS = {
  ...
  heroProduct: "https://customer-assets.emergentagent.com/job_afa1f63c-426b-4bce-8438-0d015601c035/artifacts/f43t1keq_BREATHE%20BETTER.%20%284%29.png",
...
// Mobile Key Benefits Collapsible
const MobileKeyBenefits = ({ bulletPoints }) => {
  const [isOpen, setIsOpen] = useState(false);
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <motion.div {...fadeUp} className="space-y-6">
            ...
            {/* Bullet Points - Desktop: always visible, Mobile: collapsible */}
            {/* Desktop */}
